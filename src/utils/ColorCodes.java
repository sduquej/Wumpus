 ...
 * <p>Open source code, taken from: https://gist.github.com/thefiscster510/9dc252d30b51df7d710a</p>
 *
 * <p>Color code format WITH background color:   foreground,background:</p>
 * <p>Color code format WITHOUT background color:   foreground,N:</p>
 * <p>Reset Color format:     [RC]</p>
 *
 * <p>Example Use:</p>
 * <ul>
 *  <li>String ansiColoredString = ColorCodes.ParseColors("Hello, This :blue,n:is[RC] a :red,white:response[RC].");
 *  <li>String ansiColoredString = ColorCodes.RED + "Hello" + ColorCodes.WHITE + ". This is a " + ColorColorCodes.BLUE + "test";
 * </ul>
 */
