...
public class World {
    ...
    public enum CaveItem {
        ...
        ADVENTURER {
            @Override
            public String printInMap() {
                return ColorCodes.BLUE + "A" + ColorCodes.RESET;
            }
        },
        WUMPUS {
            @Override
            public String printInMap() {
                return ColorCodes.RED + "W" + ColorCodes.RESET;
            }
        },
        EXIT {
            @Override
            public String printInMap(){
                return ColorCodes.BLUE + "E" + ColorCodes.RESET;
            }
        },
        TREASURE {
            @Override
            public String printInMap() {
                return ColorCodes.YELLOW + "T" + ColorCodes.RESET;
            }
        },
        PIT {
            @Override
            public String printInMap() {
                return ColorCodes.RED + "P" + ColorCodes.RESET;
            }
        },
        SUPERBAT {
            @Override
            public String printInMap() {
                return ColorCodes.PURPLE + "}" + ColorCodes.RESET;
            }
        ...
        BREEZE {
            @Override
            public String printInMap() {
                return ColorCodes.CYAN + "B" + ColorCodes.RESET;
            }
        },
        STENCH {
            @Override
            public String printInMap() {
                return ColorCodes.GREEN + "S" + ColorCodes.RESET;
            }
        },
        GLITTER {
            @Override
            public String printInMap() {
                return ColorCodes.YELLOW + "G" + ColorCodes.RESET;
            }
        };


        public abstract String printInMap();
    };
